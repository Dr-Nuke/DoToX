...
M.d.filepath=('C:/data/20161216 Campaign 5 Robert Z/11h34 Tmax 110kV 5mA.seq');
M.d.imsize=[1024 640];
M.d.header_size=2048;         % varian specific header size of .seq files
load('M') % M=f4_loadVideo(M) % memory bug workaround
...
M.d.crop=[3,1467]; % kepp only thoes frames (including)
