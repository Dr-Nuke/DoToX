...
varlist=round([41,61,81,101,151,201,301,401,501]);
...
plot(dx,'DisplayName','|deviation|',...
    ...
    'DisplayName',sprintf('%4.2f 1/mm',varlist(ii)/geom.d))
hold on
grid on
...
title('The influence of pixel density on the error')
%ylim([-0.2,0.2])
