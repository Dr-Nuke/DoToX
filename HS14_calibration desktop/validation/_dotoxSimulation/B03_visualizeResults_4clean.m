...
counter = counter+1; 
load(['./tomoData_clean/tomo_filmCase_' num2str(filmCase) '_filterCase_' num2str(filterCase) '_polychromatic_withFilm.mat'],'tomoNoisy');
tomoWithFilm = tomoNoisy;
load(['./tomoData_clean/tomo_filmCase_' num2str(filmCase) '_filterCase_' num2str(filterCase) '_polychromatic_empty.mat'],   'tomoNoisy');
tomoEmpty = tomoNoisy;
tomoDiff = tomoWithFilm - tomoEmpty ;
save(['./tomoData_clean/tomo_filmCase_' num2str(filmCase) '_filterCase_' num2str(filterCase) '_polychromatic_diff.mat'],'tomoDiff')
